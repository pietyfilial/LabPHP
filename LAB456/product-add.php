...
<form method="post" enctype="multipart/form-data">
    ...
    <div class="row">
        ...
        <div class="lblinput">
            <input type="file" name="txtpic" accept=".png,.gif,.jpg,.jpeg" value="<?php echo isset($_POST["txtname"]) ? $_POST["txtname"] : "" ?>">
    ...
    <div class="row">
        ...
        <div class="lblinput">
            <textarea name="txtdesc" cols="21" rows="10"><?php echo isset($_POST["txtdesc"]) ? htmlspecialchars($_POST["txtdesc"]) : ""; ?></textarea>
        </div>
    </div>
